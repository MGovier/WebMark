 ...
 * Suppress eslint new-cap due to Ground package usage.
 */

/* eslint new-cap: 0 */

// Ground is used to provide offline data access and sychronization.
...
export const MarkingSchemes = new Mongo.Collection('markingSchemes');
...
// Don't let users edit their own profile.
Meteor.users.deny({
  update() {return true;},
});
